...
enroot import docker://registry.rcp.epfl.ch#claire/moalla/deep-alignment:amd64-cuda-root-latest
...
apptainer pull docker://registry.rcp.epfl.ch/claire/moalla/deep-alignment:amd64-cuda-root-latest
```
...
git pull
cd deep-alignment/dev/installation/docker-amd64-cuda
```
...
3. Then follow the instructions [here](https://www.jetbrains.com/help/pycharm/remote-development-a.html#gateway) and
   ...
   something like `/scratch/moalla/deep-alignment/dev`).
